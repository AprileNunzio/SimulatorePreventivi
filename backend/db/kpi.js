...
function getDashboardKpi() {
  ...
  const totali = {
    ...
    pipeline_iva: preventivi.filter(p => p.stato !== 'rifiutato').reduce((s, p) => s + parseFloat(p.totale_iva || 0), 0),
    fatturato: fatturato_pagato + fatturato_accettato, 
    fatturato_latente: fatturato_accettato, 
    fatturato_reale: fatturato_pagato, 
    margine_medio: (() => {
