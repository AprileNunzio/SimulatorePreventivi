...
import ImportXmlModal from './ImportXmlModal.js';
...
export default {
  ...
  async render(el) {
    el.innerHTML = `
      <div class="page-header">
        ...
        <div class="page-actions">
          <button class="btn btn-secondary" id="btn-import-xml">📥 Importa XML</button>
    ...
    el.querySelector('#btn-import-xml')?.addEventListener('click', () =>
      this.importXml());
  ...
  importXml() {
    return ImportXmlModal.importXmlModal.call(this);
  }
};
